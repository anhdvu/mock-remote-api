...
func main() {
	...
	fmt.Println("Wallet (Companion + MPQR + RemoteMessaging) v0.4.220426-MPQR is listening on port 8888")
	log.Println("Wallet (Companion + MPQR + RemoteMessaging) v0.4.220426-MPQR is listening on port 8888")
